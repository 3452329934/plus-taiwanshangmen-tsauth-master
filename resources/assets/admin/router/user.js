...
import PrivacyAgreement from '../component/user/PrivacyAgreement'
import UserAgreement from '../component/user/UserAgreement'
...
const routers = {
  ...
  children: [
    ...
    { path: 'privacy-agreement', component: PrivacyAgreement },
    {
      path: 'vendor-easemob',
      component: vendorPages.Easemob,
      name: 'user:vendor/easemob'
    },
    {
      path: 'vendor-jpush',
      component: vendorPages.Jpush,
      name: 'user:vendor/jpush'
    },
    { path: 'vendor-qq', component: vendorPages.QQ, name: 'user:vendor/qq' },
    {
      path: 'vendor-wechat',
      component: vendorPages.WeChat,
      name: 'user:vendor/wechat'
    },
    {
      path: 'vendor-weibo',
      component: vendorPages.Weibo,
      name: 'user:vendor/weibo'
    },
    {
      path: 'vendor-wechat-mp',
      component: vendorPages.WeChatMp,
      name: 'user:vendor/wechat-mp'
    }
  ]
}
