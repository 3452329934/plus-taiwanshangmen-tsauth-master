      ...
      <div class="panel-body">
        ...
        <div class="form-horizontal" v-show="!loading">
          <div class="form-group">
            <label class="col-sm-3 control-label">隐私条款页面地址</label>
            <div class="col-sm-9">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <mavon-editor placeholder="输入隐私条款的markdown内容" v-model="content" @imgAdd="$imgAdd" ref="editor"
                            :apiHost="apiHost"/>
            </div>
          </div>
          <!-- Button -->
  ...
  export default {
    ...
    methods: {
      ...
      saveConfig () {
        ...
        let params = { url, content, type: 'privacy' }
        if (!loading) {
          this.loading = true
