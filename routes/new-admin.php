...
Route::middleware(['auth:web', 'admin'])->prefix('admin')->group(function (RouteContract $route) {
    ...
    // 极光推送
    $route->get('setting/vendor/jpush', AdminControllers\Setting\Jpush::class.'@getConfigure');
    $route->put('setting/vendor/jpush', AdminControllers\Setting\Jpush::class.'@setConfigure');
});
