...
class CreateTaskValidator extends AbstractValidator
{
     ...
     * @return array
     */
    public function rules(bool $image = false)
    : array {
        $rules = [
        ...
        if ($image) {
            $rules = array_merge($rules, [
                ...
                'dimension.width'  => [
                    'bail', 'required', 'numeric', $this->getAllowImageMinWidth(), $this->getAllowImageMaxWidth(),
                ],
                'dimension.height' => [
                    'bail', 'required', 'numeric', $this->getAllowImageMinHeight(), $this->getAllowImageMaxHeight(),
                ],
            ]);
        }
     ...
     * @return string
     */
    protected function getAllowImageMinWidth()
    : string
    {
     ...
     * @return string
     */
    protected function getAllowImageMaxWidth()
    : string
    {
     ...
     * @return string
     */
    protected function getAllowImageMinHeight()
    : string
    {
     ...
     * @return string
     */
    protected function getAllowImageMaxHeight()
    : string
    {
     ...
     * @return string
     */
    protected function getAllowMinSize()
    : string
    {
     ...
     * @return string
     */
    protected function getAllowMaxSize()
    : string
    {
     ...
     * @return string
     */
    protected function getAllowMimeTypes()
    : string
    {
