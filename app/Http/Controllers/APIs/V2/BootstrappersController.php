    ...
    public function show(BootstrapAPIsEventer $events, AdvertisingSpace $space): JsonResponse
    {
        ...
        $bootstrappers['currency'] = [
            ...
            'cash' => setting('currency', 'cash', [
                'rule' => trans('settings.currency_cash_rule'),
                'status' => true, // 提现开关
            ]),
            'recharge' => setting('currency', 'recharge', [
                'rule' => trans('settings.currency_recharge_rule'),
                'status' => true, // 充值开关
            ]),
            'rule' => setting('currency', 'rule', trans('settings.currency_rule')),
        ...
        $bootstrappers['wallet'] = [
            ...
            'labels' => array_values(setting('wallet', 'labels', [])),
