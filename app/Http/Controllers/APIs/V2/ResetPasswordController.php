...
class ResetPasswordController extends Controller
{
    ...
    {
        return [
            'old_password.required' => trans('validation.required', ['attribute' => '旧密码']),
            'old_password.string' => trans('validation.string', ['attribute' => '旧密码']),
            'password.required' => trans('validation.required', ['attribute' => '新密码']),
            'password.string' => trans('validation.string', ['attribute' => '新密码']),
            'password.different' => trans('validation.different', ['attribute' => '新密码', 'other' => '旧密码']),
            'password.confirmed' => trans('validation.confirmed', ['attribute' => '新密码'])
        ];
    }
                             ...
                             UserModel $userModel)
    {
        if ($request->input('phone') && $request->input('email')) {
            return $response->json(['message' => [trans('messages.illegal_request')]], 400);
        }
