...
class CurrencyPayController extends Controller
{
    ...
    public function getAlipayOrder(Request $request, ResponseFactory $response, NativePayOrder $order)
    {
        ...
        $order->subject = trans('messages.currency_recharge');
        $order->content = trans('messages.currency_recharge_bio', ['appname' => config('app.name'), 'amount' => $amount * $this->ratio]);
        $order->amount = $amount;
    ...
    protected function createChargeModel(Request $request, string $channel): WalletChargeModel
    {
        ...
        $charge->subject = trans('messages.currency_recharge');
        $charge->body = trans('messages.currency_recharge');
