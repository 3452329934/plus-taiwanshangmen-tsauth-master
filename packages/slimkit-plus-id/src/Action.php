...
class Action
{
    protected $actions = [
        ...
        'auth/logout' => \SlimKit\PlusID\Actions\Auth\Logout::class,
        'socialite/show' => \SlimKit\PlusID\Actions\Socialite\Show::class,
        'socialite/create' => \SlimKit\PlusID\Actions\Socialite\Create::class,
    ];
