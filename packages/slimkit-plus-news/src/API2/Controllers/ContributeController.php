...
class ContributeController extends Controller
{
    ...
    public function update(
        ...
        $map = $request->only([
            'title', 'subject', 'content', 'from', 'author', 'text_content',
        ]);
        $image = $this->app->call(function (FileWithModel $fileWith) use (
            $request
        ) {
        ...
        $images = collect([]);
        if ($map['content']) {
            $map['content'] = $this->app->make(Markdown::class)
                ->safetyMarkdown($map['content']);
        ...
        return $category->getConnection()->transaction(function () use (
            $news,
            $images,
            $response,
            $tags
    ...
    public function newStore(
        ...
        $images[] = $this->app->call(function (FileWithModel $fileWith) use (
            $map
        ) {
