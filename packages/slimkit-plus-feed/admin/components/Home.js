...
class Home extends Component {
  ...
  render () {
    ...
    const { feeds = 0, comments = 0, close, open, data, type, drawerOpen, loading } = this.state
          ...
          >
            <div tabIndex={0} role="button">
              <List className={classes.drawer}
                ...
                <Collapse in={type === 'all'} transitionDuration="auto"
                          unmountOnExit>
                  <ListItem button className={classes.nested}>
                    <Link className={classes.link} to="/feeds?type=all">
                      <ListItemText className={classes.text} inset
                                    primary="动态数量" secondary={data.feedsCount}/>
                    </Link>
                  </ListItem>
                  <ListItem button className={classes.nested}>
                    <Link className={classes.link}
                          to="/feeds?type=all&pay=paid">
                      <ListItemText className={classes.text} inset
                                    primary="收费动态"
                  ...
                  <ListItem button className={classes.nested}>
                    <Link className={classes.link} to="/feeds?type=all&top=yes">
                      <ListItemText className={classes.text} inset
                                    primary="置顶动态" secondary={data.topFeed}/>
                    </Link>
                  </ListItem>
                  <ListItem button className={classes.nested}>
                    <Link className={classes.link}
                      ...
                      <ListItemText className={classes.text} inset
                                    primary="置顶评论" secondary={data.topComment}/>
                    </Link>
                  </ListItem>
                  <ListItem button className={classes.nested}>
                    <ListItemText className={classes.text} inset primary="收到金额"
                ...
                <Collapse in={type === 'today'} transitionDuration="auto"
                          unmountOnExit>
                  <ListItem button className={classes.nested}>
                ...
                <Collapse in={type === 'yesterday'} transitionDuration="auto"
                          unmountOnExit>
                  <ListItem button className={classes.nested}>
                    <Link className={classes.link} to="/feeds?type=yesterday">
                      <ListItemText inset primary="动态数量"
                  ...
                  <ListItem button className={classes.nested}>
                    <Link className={classes.link}
                      ...
                      <ListItemText inset primary="收费动态"
                                    secondary={data.payFeedsCount}/>
                    </Link>
                  </ListItem>
                  <ListItem button className={classes.nested}>
                    <Link className={classes.link}
                          to="/comments?type=yesterday">
                      <ListItemText inset primary="评论数量"
                                    secondary={data.commentsCount}/>
                    </Link>
                  </ListItem>
                  <ListItem button className={classes.nested}>
                  ...
                  <ListItem button className={classes.nested}>
                    <ListItemText inset primary="收到金额"
                                  secondary={showAmount(data.payCount)}/>
                  </ListItem>
                </Collapse>
                <ListItem
                ...
                <Collapse in={type === 'week'} transitionDuration="auto"
                          unmountOnExit>
                  <ListItem button className={classes.nested}>
                ...
                <Collapse in={type === 'lastDay'} transitionDuration="auto"
                          unmountOnExit>
                  <ListItem button className={classes.nested}>
          ...
          <Dialog open={close.reward.status === 'false'}>
            ...
            <DialogActions>
              {close.reward.ing
                  ...
                  : <Button
                      onClick={() => this.handleCloseRewardDialog()}>取消</Button>
              }
              {close.reward.ing
                  ? <Button disabled><CircularProgress size={14}/></Button>
                  : <Button color="primary"
                            onClick={() => this.handleRewardStore()}>关闭</Button>
              }
            </DialogActions>
          </Dialog>
          <Snackbar
